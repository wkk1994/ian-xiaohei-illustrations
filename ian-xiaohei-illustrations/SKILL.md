...
description: 生成 Ian 风格的中文正文配图。用于用户要求为中文文章、帖子、博客、Notion 文档、工作流文档、方法论、流程、结构、状态、隐喻或观点生成“怪诞”“小猫”“xiaomao”“手绘”“正文配图”“文章插图”“配图建议”“shot list”“去标题/改图”等任务；默认使用小猫 IP、纯白手绘、少量红橙蓝批注、简洁清爽但天马行空的视觉风格。
---
...
默认视觉 IP 是“小猫”：一只圆脸、蓝灰短毛、琥珀眼、戴红色小龙虾钳子毛绒发箍的母蓝猫。小猫必须参与画面的核心动作，不能只是站在旁边当装饰。
...
- `references/xiaomao-ip.md`：小猫 IP 的形象、性格、动作库和禁忌。
