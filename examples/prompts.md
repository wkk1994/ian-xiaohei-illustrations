...
```text
Use $ian-xiaohei-illustrations 这张图方向对，但小猫有点像装饰。
请保持核心意思不变，重生成一版：让小猫成为真正推动结构运转的角色。
画面更怪一点，但仍然纯白、清爽、少字。
```
...
```text
Use $ian-xiaohei-illustrations 输出 5 个不同主题的小猫正文配图效果。
